...
const PostDataAccess_1 = require("../data-access/PostDataAccess");
const router = express_1.default.Router();
const postController = new PostController_1.PostController(new PostServices_1.PostServices(new PostDataAccess_1.PostDataAccess()));
